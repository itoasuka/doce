...
public class BasicDataSourceProvider implements Provider<DataSource> {
     ...
     */
    @Inject(optional = true)
    public void setConnectionProperties(@Named("DBCP.connectionProperties") String connectionProperties) {
        LOGGER.debug(MessageCodes.DG002, "DBCP.connectionProperties", connectionProperties);
     ...
     */
    @Inject(optional = true)
    public void setDefaultAutoCommit(@Named("DBCP.defaultAutoCommit") Boolean defaultAutoCommit) {
        LOGGER.debug(MessageCodes.DG002, "DBCP.defaultAutoCommit", defaultAutoCommit);
    ...
    public void setDefaultReadOnly(@Named("DBCP.defaultReadOnly") Boolean defaultReadOnly) {
        LOGGER.debug(MessageCodes.DG002, "DBCP.defaultReadOnly", defaultReadOnly);
     ...
     */
    @Inject(optional = true)
    public void setDefaultReadOnly(@Named("DBCP.defaultTransactionIsolation") int defaultTransactionIsolation) {
        LOGGER.debug(MessageCodes.DG002, "DBCP.defaultTransactionIsolation", defaultTransactionIsolation);
