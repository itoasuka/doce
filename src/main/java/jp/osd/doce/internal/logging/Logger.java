...
public abstract class Logger {
	 ...
	 *            ログメッセージに埋め込む引数
	 */
	public abstract void info(MessageCodes codes, Object... arguments);

	/**
	 * WARN レベルでログを取ります。
	 * 
	 * @param codes ログメッセージのメッセージコード
	 * @param arguments ログメッセージに埋め込む引数
	 * @since 1.0.0
	 */
	public abstract void warn(MessageCodes codes, Object... arguments);
	...
	public void logConstructor(Class<?>... argumentClasses) {
		if (isDebugEnabled()) {
			...
			String className = new Exception().getStackTrace()[1]
					.getClassName();
